...
const SideNav = () => {
  ...
  return (
    <div className="w-[18vw] text-white flex flex-col gap-2 px-4 py-2 mt-2">
        <div className='border-b-[0.5px] mb-2 pb-4 border-slate-300'>
            <ul className='text-lg'>
                <li className='flex items-center gap-2 p-2  border-[#272727] rounded-lg hover:bg-[#272727]'><Link className='flex items-center gap-2' to="/"><IoMdHome />Home</Link></li>
